...
class TestCollisionChecker(unittest.TestCase):
    def test_absence_of_shape(self):
        ...
        result = CollisionChecker(global_obstacle_points=obstacle_points).check(robot_center)
    ...
    def test_rectangular_shape_collision_true(self):
        ...
        shape = Rectangle(2, 3)
        result = CollisionChecker(shape, global_obstacle_points=obstacle_points).check(robot_center)
